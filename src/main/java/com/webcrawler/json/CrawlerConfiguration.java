...
public final class CrawlerConfiguration {
   ...
   * {@link WebCrawler} implementation, for example
   * {@code "com.webcrawler.SequentialWebCrawler"}.
   *
  ...
  public static final class Builder {
    ...
    /**
     * Overrides the {@link WebCrawler} implementation that should be used
     * for the crawl.
     *
